...
0000000000400e50 <deregister_tm_clones>:
  400e50:	b8 bf 54 60 00       	mov    $0x6054bf,%eax
  400e55:	55                   	push   %rbp
  400e56:	48 2d b8 54 60 00    	sub    $0x6054b8,%rax
  ...
  400e71:	5d                   	pop    %rbp
  400e72:	bf b8 54 60 00       	mov    $0x6054b8,%edi
  400e77:	ff e0                	jmpq   *%rax
  400e79:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)

0000000000400e80 <register_tm_clones>:
  400e80:	b8 b8 54 60 00       	mov    $0x6054b8,%eax
  400e85:	55                   	push   %rbp
  400e86:	48 2d b8 54 60 00    	sub    $0x6054b8,%rax
  ...
  400eb2:	bf b8 54 60 00       	mov    $0x6054b8,%edi
...
0000000000400f90 <initialize_target>:
  ...
  40100a:	48 89 05 9f 44 20 00 	mov    %rax,0x20449f(%rip)        # 6054b0 <buf_offset>
  401011:	c6 05 2c 41 20 00 72 	movb   $0x72,0x20412c(%rip)        # 605144 <target_prefix>
...
00000000004010e0 <main>:
  ...
  401185:	be ed 31 40 00       	mov    $0x4031ed,%esi
  ...
  401289:	48 8b 3d 20 42 20 00 	mov    0x204220(%rip),%rdi        # 6054b0 <buf_offset>
...
00000000004016d6 <touch1>:
  ...
  4016e1:	00 00 00 
  4016e4:	bf 43 30 40 00       	mov    $0x403043,%edi
...
0000000000401702 <touch2>:
  ...
  40171a:	bf 68 30 40 00       	mov    $0x403068,%edi
  ...
  401735:	bf 90 30 40 00       	mov    $0x403090,%edi
...
0000000000401758 <hexmatch>:
  ...
  4017a3:	be 60 30 40 00       	mov    $0x403060,%esi
...
00000000004017d6 <touch3>:
  ...
  4017f9:	bf b8 30 40 00       	mov    $0x4030b8,%edi
  ...
  401817:	bf e0 30 40 00       	mov    $0x4030e0,%edi
...
000000000040183a <test>:
  ...
  40184a:	bf 08 31 40 00       	mov    $0x403108,%edi
...
0000000000401864 <addval_152>:
  401864:	8d 87 48 89 c7 90    	lea    -0x6f3876b8(%rdi),%eax
  40186a:	c3                   	retq   
...
00000000004018a7 <addval_215>:
  4018a7:	8d 87 a9 d6 84 c9    	lea    -0x367b2957(%rdi),%eax
  4018ad:	c3                   	retq   
...
00000000004018b5 <setval_386>:
  4018b5:	c7 07 09 d6 20 c9    	movl   $0xc920d609,(%rdi)
  4018bb:	c3                   	retq   

00000000004018bc <getval_202>:
  4018bc:	b8 48 8b e0 c3       	mov    $0xc3e08b48,%eax
  4018c1:	c3                   	retq   
...
00000000004018c9 <setval_305>:
  4018c9:	c7 07 48 89 e0 c3    	movl   $0xc3e08948,(%rdi)
  4018cf:	c3                   	retq   

00000000004018d0 <getval_129>:
  4018d0:	b8 89 ca 48 c0       	mov    $0xc048ca89,%eax
  4018d5:	c3                   	retq   

00000000004018d6 <setval_188>:
  4018d6:	c7 07 a9 c1 84 c9    	movl   $0xc984c1a9,(%rdi)
  4018dc:	c3                   	retq   
...
00000000004018e3 <getval_201>:
  4018e3:	b8 89 d6 18 c0       	mov    $0xc018d689,%eax
  4018e8:	c3                   	retq   

00000000004018e9 <getval_126>:
  4018e9:	b8 89 d6 18 db       	mov    $0xdb18d689,%eax
  4018ee:	c3                   	retq   

00000000004018ef <getval_429>:
  4018ef:	b8 b8 89 ca c7       	mov    $0xc7ca89b8,%eax
  4018f4:	c3                   	retq   

00000000004018f5 <getval_487>:
  4018f5:	b8 89 c1 84 d2       	mov    $0xd284c189,%eax
  4018fa:	c3                   	retq   

00000000004018fb <addval_289>:
  4018fb:	8d 87 89 ca 94 db    	lea    -0x246b3577(%rdi),%eax
  401901:	c3                   	retq   

0000000000401902 <addval_497>:
  401902:	8d 87 48 89 e0 c7    	lea    -0x381f76b8(%rdi),%eax
  401908:	c3                   	retq   

0000000000401909 <getval_431>:
  401909:	b8 8d c1 08 d2       	mov    $0xd208c18d,%eax
  40190e:	c3                   	retq   

000000000040190f <getval_353>:
  40190f:	b8 89 ca 20 d2       	mov    $0xd220ca89,%eax
  401914:	c3                   	retq   

0000000000401915 <addval_413>:
  401915:	8d 87 89 ca 91 c3    	lea    -0x3c6e3577(%rdi),%eax
  40191b:	c3                   	retq   

000000000040191c <addval_314>:
  40191c:	8d 87 48 89 e0 c7    	lea    -0x381f76b8(%rdi),%eax
  401922:	c3                   	retq   

0000000000401923 <setval_449>:
  401923:	c7 07 a9 ca 38 c0    	movl   $0xc038caa9,(%rdi)
  401929:	c3                   	retq   

000000000040192a <setval_169>:
  40192a:	c7 07 c9 d6 c3 ef    	movl   $0xefc3d6c9,(%rdi)
  401930:	c3                   	retq   

0000000000401931 <addval_372>:
  401931:	8d 87 89 c1 30 c9    	lea    -0x36cf3e77(%rdi),%eax
  401937:	c3                   	retq   

0000000000401938 <setval_424>:
  401938:	c7 07 48 89 e0 94    	movl   $0x94e08948,(%rdi)
  40193e:	c3                   	retq   
...
0000000000401945 <addval_106>:
  401945:	8d 87 63 89 c1 91    	lea    -0x6e3e769d(%rdi),%eax
  40194b:	c3                   	retq   

000000000040194c <getval_397>:
  40194c:	b8 89 d6 c3 1f       	mov    $0x1fc3d689,%eax
  401951:	c3                   	retq   

0000000000401952 <setval_307>:
  401952:	c7 07 99 8d c1 90    	movl   $0x90c18d99,(%rdi)
  401958:	c3                   	retq   

0000000000401959 <getval_331>:
  401959:	b8 8d ca 20 d2       	mov    $0xd220ca8d,%eax
  40195e:	c3                   	retq   

000000000040195f <getval_336>:
  40195f:	b8 48 89 e0 c1       	mov    $0xc1e08948,%eax
  401964:	c3                   	retq   

0000000000401965 <setval_391>:
  401965:	c7 07 48 89 e0 c2    	movl   $0xc2e08948,(%rdi)
  40196b:	c3                   	retq   

000000000040196c <getval_211>:
  40196c:	b8 89 d6 91 c3       	mov    $0xc391d689,%eax
  401971:	c3                   	retq   

0000000000401972 <getval_257>:
  401972:	b8 89 c1 00 c0       	mov    $0xc000c189,%eax
  401977:	c3                   	retq   

0000000000401978 <end_farm>:
  401978:	b8 01 00 00 00       	mov    $0x1,%eax
  40197d:	c3                   	retq   
...
0000000000401980 <save_char>:
  ...
  401998:	0f b6 b1 30 34 40 00 	movzbl 0x403430(%rcx),%esi
  ...
  4019af:	0f b6 b7 30 34 40 00 	movzbl 0x403430(%rdi),%esi
...
00000000004019eb <check_fail>:
  ...
  4019ef:	0f be 35 4e 37 20 00 	movsbl 0x20374e(%rip),%esi        # 605144 <target_prefix>
  4019f6:	b9 20 55 60 00       	mov    $0x605520,%ecx
  4019fb:	8b 15 f7 3a 20 00    	mov    0x203af7(%rip),%edx        # 6054f8 <check_level>
  401a01:	bf 2b 31 40 00       	mov    $0x40312b,%edi
...
0000000000401a6c <notify_server>:
  ...
  401a93:	bf 60 32 40 00       	mov    $0x403260,%edi
  ...
  401aac:	44 0f be 0d 90 36 20 	movsbl 0x203690(%rip),%r9d        # 605144 <target_prefix>
  401ab3:	00 
  ...
  401ad0:	b9 41 31 40 00       	mov    $0x403141,%ecx
  401ad5:	eb 05                	jmp    401adc <notify_server+0x70>
  401ad7:	b9 46 31 40 00       	mov    $0x403146,%ecx
  ...
  401aee:	be 4b 31 40 00       	mov    $0x40314b,%esi
  ...
  401b2c:	48 8b 35 6d 39 20 00 	mov    0x20396d(%rip),%rsi        # 6054a0 <course>
  ...
  401b48:	bf 67 31 40 00       	mov    $0x403167,%edi
  ...
  401b8a:	be 41 31 40 00       	mov    $0x403141,%esi
  401b8f:	90                   	nop
  401b90:	eb 05                	jmp    401b97 <notify_server+0x12b>
  401b92:	be 46 31 40 00       	mov    $0x403146,%esi
  401b97:	bf c8 32 40 00       	mov    $0x4032c8,%edi
  ...
  401bad:	bf 84 31 40 00       	mov    $0x403184,%edi
  401bb2:	b8 00 00 00 00       	mov    $0x0,%eax
  401bb7:	e8 c4 f0 ff ff       	callq  400c80 <printf@plt>
  401bbc:	48 8b 35 dd 38 20 00 	mov    0x2038dd(%rip),%rsi        # 6054a0 <course>
  401bc3:	bf 91 31 40 00       	mov    $0x403191,%edi
  ...
  401bd9:	bf 9d 31 40 00       	mov    $0x40319d,%edi
  ...
  401bef:	00 
  401bf0:	bf a6 31 40 00       	mov    $0x4031a6,%edi
...
0000000000401c09 <validate>:
  ...
  401c1d:	bf b2 31 40 00       	mov    $0x4031b2,%edi
  ...
  401c3d:	bf f0 32 40 00       	mov    $0x4032f0,%edi
  ...
  401c56:	0f be 35 e7 34 20 00 	movsbl 0x2034e7(%rip),%esi        # 605144 <target_prefix>
  401c5d:	b9 20 55 60 00       	mov    $0x605520,%ecx
  401c62:	89 fa                	mov    %edi,%edx
  401c64:	bf d0 31 40 00       	mov    $0x4031d0,%edi
  ...
  401c7d:	bf b2 31 40 00       	mov    $0x4031b2,%edi
  ...
  401c95:	0f be 15 a8 34 20 00 	movsbl 0x2034a8(%rip),%edx        # 605144 <target_prefix>
  401c9c:	89 fe                	mov    %edi,%esi
  401c9e:	bf 18 33 40 00       	mov    $0x403318,%edi
...
0000000000401ce3 <bushandler>:
  ...
  401cf0:	bf e5 31 40 00       	mov    $0x4031e5,%edi
  ...
  401d04:	bf 50 33 40 00       	mov    $0x403350,%edi
  401d09:	e8 42 ef ff ff       	callq  400c50 <puts@plt>
  401d0e:	bf ef 31 40 00       	mov    $0x4031ef,%edi
...
0000000000401d31 <seghandler>:
  ...
  401d3e:	bf 05 32 40 00       	mov    $0x403205,%edi
  ...
  401d52:	bf 70 33 40 00       	mov    $0x403370,%edi
  401d57:	e8 f4 ee ff ff       	callq  400c50 <puts@plt>
  401d5c:	bf ef 31 40 00       	mov    $0x4031ef,%edi
...
0000000000401d7f <illegalhandler>:
  ...
  401d8c:	bf 18 32 40 00       	mov    $0x403218,%edi
  ...
  401da0:	bf 98 33 40 00       	mov    $0x403398,%edi
  401da5:	e8 a6 ee ff ff       	callq  400c50 <puts@plt>
  401daa:	bf ef 31 40 00       	mov    $0x4031ef,%edi
...
0000000000401dcd <sigalrmhandler>:
  ...
  401dda:	bf 2c 32 40 00       	mov    $0x40322c,%edi
  ...
  401df3:	bf c8 33 40 00       	mov    $0x4033c8,%edi
...
0000000000401e1b <launch>:
  ...
  401e50:	bf 34 32 40 00       	mov    $0x403234,%edi
  ...
  401e7c:	bf 41 32 40 00       	mov    $0x403241,%edi
  ...
  401e90:	bf 4c 32 40 00       	mov    $0x40324c,%edi
...
0000000000401e9c <stable_launch>:
  ...
  401ee6:	be 00 34 40 00       	mov    $0x403400,%esi
  ...
  401f0d:	48 89 15 14 42 20 00 	mov    %rdx,0x204214(%rip)        # 606128 <stack_top>
...
0000000000401f62 <sigalrm_handler>:
  ...
  401f6b:	be 40 34 40 00       	mov    $0x403440,%esi
...
0000000000401f8b <urlencode>:
  ...
  402011:	be d8 34 40 00       	mov    $0x4034d8,%esi
...
00000000004021c7 <submitr>:
  ...
  40251f:	be 68 34 40 00       	mov    $0x403468,%esi
  ...
  402694:	00 
  402695:	be df 34 40 00       	mov    $0x4034df,%esi
  ...
  40282d:	be a8 34 40 00       	mov    $0x4034a8,%esi
  ...
  40288d:	bf f0 34 40 00       	mov    $0x4034f0,%edi
...
000000000040290a <init_driver>:
  ...
  4029a9:	bf c7 2f 40 00       	mov    $0x402fc7,%edi
  ...
  402a4c:	66 c7 44 24 02 47 26 	movw   $0x2647,0x2(%rsp)
...
0000000000402ad3 <driver_post>:
  ...
  402ae3:	bf f5 34 40 00       	mov    $0x4034f5,%edi
  ...
  402b1c:	be 26 47 00 00       	mov    $0x4726,%esi
  402b21:	bf c7 2f 40 00       	mov    $0x402fc7,%edi
